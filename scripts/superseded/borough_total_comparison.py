...
vals_2024 = [m2024['vol'].sum(), b2024['vol'].sum()]
vals_2025 = [m2025['vol'].sum(), b2025['vol'].sum()]
...
ax.set_title('Total Traffic: Manhattan vs Bronx, 2024 vs 2025')
ax.legend()

plt.savefig('outputs/borough_total_comparison.png')