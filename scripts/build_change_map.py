...
build_district_map(2024, 'map_2024.html')
build_district_map(2025, 'map_2025.html')

# MAP 3: 2026 EPA monitors, tighter crop
...
m3.save('outputs/map_2026_partial.html')
print("Saved map_2026_partial.html")